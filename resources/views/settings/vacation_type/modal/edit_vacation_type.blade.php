<!-- The Modal -->
<div class="modal fade" id="VacationEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">تعديل نوع الإجازة</h5>
            ...
            <div class="modal-body">
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="message-text" class="col-form-label">نوع الإجازة</label>
