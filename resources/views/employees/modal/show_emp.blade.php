<!-- The Modal -->
<div class="modal fade" id="EmpShow" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">تعديل النوع</h5>
                <button type="button" class="btn-close position-absolute " style="left: 10px" data-bs-dismiss="modal"
            ...
            <div class="modal-body">
                <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="mother_name" value="{{ $employee->mother_name }}" type="text"
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="email" type="text" value="{{ $employee->email }}" class="form-control"
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="id_number" value="{{ $employee->id_number }}" type="text"
                            class="form-control" id="validationCustom02" required>
                        <div class="valid-feedback">
                            Looks good!
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="birthdate" value="{{ $employee->birthdate }}" type="date"
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="id_state" class="form-select" id="validationCustom04" required>
                            ...
                            @foreach ($status as $state)
                                <option @if ($state->id_state === $employee->id_state) selected @endif
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="expertise" type="text" value="{{ $employee->expertise }}"
                            class="form-control" id="validationCustom03" required>
                        <div class="invalid-feedback">
                            Please provide a valid city.
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="expertise_start_date" value="{{ $employee->expertise_start_date }}"
                            type="date" class="form-control" id="validationCustom05" required>
                        <div class="invalid-feedback">
                            Please provide a valid zip.
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <input name="bank_name" type="text" value="{{ $employee->bank_name }}"
                            class="form-control" id="validationCustom03" required>
                        <div class="invalid-feedback">
                            Please provide a valid city.
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="bank_branch" value="{{ $employee->bank_branch }}" type="text"
                            class="form-control" id="validationCustom03" required>
                        <div class="invalid-feedback">
                            Please provide a valid city.
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="bank_account_id" value="{{ $employee->bank_account_id }}" type="text"
                            class="form-control" id="validationCustom03" required>
                        <div class="invalid-feedback">
                            Please provide a valid city.
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="last_premotion_date" value="{{ $employee->last_premotion_date }}"
                            type="date" class="form-control" id="validationCustom05" required>
                        <div class="invalid-feedback">
                            Please provide a valid zip.
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="decision_date" value="{{ $employee->decision_date }}" type="date"
                            class="form-control" id="validationCustom05" required>
                        <div class="invalid-feedback">
                            Please provide a valid zip.
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="id_jop" class="form-select" id="validationCustom04" required>
                            ...
                            @foreach ($jopTitles as $jobTitle)
                                <option @if ($jobTitle->id_jop === $employee->id_jop) selected @endif
                                    value="{{ $jobTitle->id_jop }}">
                    ...
                    <div class="col-md-3">
                        ...
                        <input name="" type="file" class="form-control" aria-label="file example"
                            required>
